...
import (
	...
	"github.com/arran4/eightbyeight/cmd/eightbyeight/templates"
)
...
func NewRoot(name, version, commit, date string) (*RootCmd, error) {
	...
	c.Commands["all"] = c.NewAll()
	c.Commands["bw"] = c.NewBw()
	c.Commands["mixing"] = c.NewMixing()
	c.Commands["solarized"] = c.NewSolarized()
	c.Commands["terminal"] = c.NewTerminal()
