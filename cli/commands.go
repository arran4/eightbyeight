...
// GenerateAll is a subcommand `eightbyeight all`
...
// GenerateBW is a subcommand `eightbyeight bw`
// Generate Classic - Black on White
func GenerateBW() {
...
// GenerateTerminal is a subcommand `eightbyeight terminal`
// Generate Terminal Style (Green on Black)
...
// GenerateSolarized is a subcommand `eightbyeight solarized`
// Generate Solarized (Beige and Dark Teal)
func GenerateSolarized() {
...
// GenerateMixing is a subcommand `eightbyeight mixing`
// Generate CGA Palette Mixing
func GenerateMixing() {
